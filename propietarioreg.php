...
<body>
	<?php
		...
		// Registramos datos personales únicamente
			$propietario = new Propietario( $id, $primNombre, $segundoNom, $primApellido,
			$segApellido);			
			$propietario -> registrarUsuario( $propietario );
		...
		else
		{
			...
			$campos_registrar_apartamento = array( "num_apartamento", "persona_identificacion", "num_torre" );
