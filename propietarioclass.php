...
<?php
	...
	/*
		Clase propietario: esta clase hereda o extiende 
		...
		registrar los diferentes atributos en la tabla propietario.
	*/
	class Propietario extends UsuarioPH
	{		
		...
		*/
		...
		{			
			...
			VALUES('{$usuario -> identificacion}', '{$usuario -> primerNombre}', '{$usuario -> segundoNombre}', '{$usuario -> primerApellido}', '{$usuario -> segundoApellido}', '$propietario'); ";		


			// Realización de consulta: 
			if( $enlace->query( $instruccionSQL ) === TRUE )
			{				
				 echo "	<b><center>REGISTRO EXITOSO</center></b>";    
			}
